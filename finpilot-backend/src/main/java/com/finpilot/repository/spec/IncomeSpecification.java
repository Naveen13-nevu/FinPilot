...
public final class IncomeSpecification {
    ...
    public static Specification<Income> build(User user, TransactionSearchRequest filter) {
        return (root, query, cb) -> {
            ...
            if (StringUtils.hasText(filter.getKeyword())) {
                ...
                Predicate sourceMatch = cb.like(cb.lower(root.get("source")), likePattern);
                predicates.add(cb.or(descMatch, sourceMatch));
            }
